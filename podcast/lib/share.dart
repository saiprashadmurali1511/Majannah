                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              Get.to(NowPlaying(), transition: Transition.leftToRight);
                            },
                            child: Text(
                              'Cancel',
                              style: TextStyle(
                            ...
                            style: ElevatedButton.styleFrom(
                              primary: Colors.transparent,
                              onPrimary: Color(0xFFFFFFFF), // Set text color when pressed
                              elevation: 0,
                              side: BorderSide(color: Color(0xFF9EB8C8), width: 1.0),
                              minimumSize: Size(370, 57),
                            ),
                          ),
                        ],
